...
public class PlotAdd implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (!members.contains(playertje)){
			members.addPlayer( playertje ); 
		}else{
			sender.sendMessage(ChatColor.RED + "De speler was al op het plot!");
			return true;
		}
